...
import * as import0 from '../../../../../../src/ng2-smart-table/components/cell/cell-editors/input-editor.component';
...
export class Wrapper_InputEditorComponent {
  /*private*/ _eventHandler:Function;
  context:import0.InputEditorComponent;
  ...
  constructor() {
    this._changed = false;
    this.context = new import0.InputEditorComponent();
...
var renderType_InputEditorComponent_Host:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.None,([] as any[]),{});
class View_InputEditorComponent_Host0 extends import2.AppView<any> {
  _el_0:any;
  compView_0:import2.AppView<import0.InputEditorComponent>;
  _InputEditorComponent_0_3:Wrapper_InputEditorComponent;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_InputEditorComponent_Host0,renderType_InputEditorComponent_Host,import6.ViewType.HOST,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  }
  createInternal(rootSelector:string):import8.ComponentRef<any> {
    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer,'input-editor',import3.EMPTY_INLINE_ARRAY,rootSelector,(null as any));
    this.compView_0 = new View_InputEditorComponent0(this.viewUtils,this,0,this._el_0);
    this._InputEditorComponent_0_3 = new Wrapper_InputEditorComponent();
    this.compView_0.create(this._InputEditorComponent_0_3.context);
    this.init(this._el_0,((<any>this.renderer).directRenderer? (null as any): [this._el_0]),(null as any));
    return new import8.ComponentRef_<any>(0,this,this._el_0,this._InputEditorComponent_0_3.context);
  }
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import0.InputEditorComponent) && (0 === requestNodeIndex))) { return this._InputEditorComponent_0_3.context; }
...
export const InputEditorComponentNgFactory:import8.ComponentFactory<import0.InputEditorComponent> = new import8.ComponentFactory<import0.InputEditorComponent>('input-editor',View_InputEditorComponent_Host0,import0.InputEditorComponent);
const styles_InputEditorComponent:any[] = [import9.styles];
var renderType_InputEditorComponent:import4.RenderComponentType = import3.createRenderComponentType('',0,import5.ViewEncapsulation.Emulated,styles_InputEditorComponent,{});
export class View_InputEditorComponent0 extends import2.AppView<import0.InputEditorComponent> {
  _text_0:any;
  _el_1:any;
  ...
  /*private*/ _expr_9:any;
  constructor(viewUtils:import3.ViewUtils,parentView:import2.AppView<any>,parentIndex:number,parentElement:any) {
    super(View_InputEditorComponent0,renderType_InputEditorComponent,import6.ViewType.COMPONENT,viewUtils,parentView,parentIndex,parentElement,import7.ChangeDetectorStatus.CheckAlways);
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    ...
    if (((token === import20.NgModel) && (1 === requestNodeIndex))) { return this._NgModel_1_6.context; }
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_9:any = this.context.cell.getTitle();
    if (import3.checkBinding(throwOnChange,this._expr_9,currVal_9)) {
      this.renderer.setElementProperty(this._el_1,'placeholder',currVal_9);
